...
namespace openmore
{
  ...
  public:
    ...
    ThorTrajectoryProcessor(const KinodynamicConstraintsPtr &constraints,
                            ...
                            const cnr_logger::TraceLoggerPtr &logger) : SplineTrajectoryProcessor(constraints, param_ns, logger)
    {
    ...
    ThorTrajectoryProcessor(const KinodynamicConstraintsPtr &constraints,
                            ...
                            const std::vector<Eigen::VectorXd> &path) : SplineTrajectoryProcessor(constraints, param_ns, logger, path)
    {
      ThorTrajectoryProcessor::setConstraints(constraints);
    }
    ...
    ThorTrajectoryProcessor(const KinodynamicConstraintsPtr &constraints,
                            const std::string &param_ns,
                            const cnr_logger::TraceLoggerPtr &logger,
                            const spline_order_t &spline_order) : SplineTrajectoryProcessor(constraints, param_ns, logger, spline_order)
    {
      ThorTrajectoryProcessor::setConstraints(constraints);
    }
    ...
    ThorTrajectoryProcessor(const KinodynamicConstraintsPtr &constraints,
                            ...
                            const spline_order_t &spline_order) : SplineTrajectoryProcessor(constraints, param_ns, logger, path, spline_order)
    {
      ThorTrajectoryProcessor::setConstraints(constraints);
    }
    ...
    ThorTrajectoryProcessor(const KinodynamicConstraintsPtr &constraints,
                            ...
                            const QpIntervalsPtr intervals) : SplineTrajectoryProcessor(constraints, param_ns, logger, path, spline_order)
    {
