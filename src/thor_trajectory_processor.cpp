...
namespace openmore
{
    ...
    void ThorTrajectoryProcessor::setSafetyParameters(const QpSafetyParametersPtr& safety_parameters)
    {
       thor.activateCbfBounds(true);
       thor.setCBFParameters(safety_parameters->a_s, safety_parameters->T_r, safety_parameters->C, safety_parameters->gamma);
    }
}
